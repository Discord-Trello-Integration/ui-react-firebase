...
const firebaseConfig = {
  apiKey: process.env.REACT_APP_FIREBASE_API_KEY, // Clave de la API de Firebase
  authDomain: process.env.REACT_APP_FIREBASE_AUTH_DOMAIN, // Dominio de autenticación de Firebase
  projectId: process.env.REACT_APP_FIREBASE_PROJECT_ID, // ID del proyecto en Firebase
  storageBucket: process.env.REACT_APP_FIREBASE_STORAGE_BUCKET, // Bucket de almacenamiento en Firebase
  messagingSenderId: process.env.REACT_APP_FIREBASE_MESSAGING_SENDER_ID, // ID del remitente de mensajería en Firebase
  appId: process.env.REACT_APP_FIREBASE_APP_ID // ID de la aplicación en Firebase
};
